...
export interface ElamNode extends NamedNodeBase {
  type: SyntaxType.Elam;
  bodyNode: ElamNode | TypeExprNode;
  paramNode: ParamNode;
}
...
export interface IlamNode extends NamedNodeBase {
  type: SyntaxType.Ilam;
  bodyNode: IlamNode | TypeExprNode;
  paramNode: ParamNode;
}
...
export interface LambdaNode extends NamedNodeBase {
  ...
  explicitNode?: ElamNode;
  implicitNode?: IlamNode;
}
...
export interface OperationNode extends NamedNodeBase {
  ...
  leftNode: ExprNode;
  operatorNode: UnnamedNode<"!="> | UnnamedNode<"%"> | UnnamedNode<"*"> | UnnamedNode<"+"> | UnnamedNode<"++"> | UnnamedNode<"-"> | UnnamedNode<"/"> | UnnamedNode<"<"> | UnnamedNode<"<="> | UnnamedNode<"<>"> | UnnamedNode<"<|"> | UnnamedNode<"=="> | UnnamedNode<">"> | UnnamedNode<">="> | AndNode | OrNode | UnnamedNode<"|>">;
  rightNode: ExprNode;
}
