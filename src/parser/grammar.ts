...
const grammar: Grammar = {
	...
	ParserRules: [
		...
		{ name: "Ann", symbols: ["Ann", "Ann$ebnf$1", lexer.has("colon") ? { type: "colon" } : colon, "Ann$ebnf$2", "ModalExpr"], postprocess: P.Annotation },
		...
		{ name: "Ann", symbols: ["Ann", "Ann$ebnf$3", lexer.has("colon") ? { type: "colon" } : colon, "Ann$ebnf$4", "TypeExpr"], postprocess: P.Annotation },
		{ name: "Ann", symbols: ["TypeExpr"], postprocess: id },
		{ name: "ModalExpr$macrocall$2", symbols: ["Quantity"] },
		{ name: "ModalExpr$macrocall$1$macrocall$2", symbols: ["ModalExpr$macrocall$2"] },
		{ name: "ModalExpr$macrocall$1$macrocall$3", symbols: [lexer.has("langle") ? { type: "langle" } : langle] },
		{ name: "ModalExpr$macrocall$1$macrocall$4", symbols: [lexer.has("rangle") ? { type: "rangle" } : rangle] },
		{ name: "ModalExpr$macrocall$1$macrocall$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "ModalExpr$macrocall$1$macrocall$1$ebnf$1", symbols: [], postprocess: () => null },
		{
			name: "ModalExpr$macrocall$1$macrocall$1",
			symbols: [
				"ModalExpr$macrocall$1$macrocall$3",
				"ModalExpr$macrocall$1$macrocall$2",
				"ModalExpr$macrocall$1$macrocall$1$ebnf$1",
				"ModalExpr$macrocall$1$macrocall$4",
			],
			postprocess: P.unwrap,
		},
		{ name: "ModalExpr$macrocall$1", symbols: ["ModalExpr$macrocall$1$macrocall$1"], postprocess: P.enclosed },
		{ name: "ModalExpr$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "ModalExpr$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "ModalExpr", symbols: ["ModalExpr$macrocall$1", "ModalExpr$ebnf$1", "TypeExpr"], postprocess: P.Modal },
		{ name: "ModalExpr$macrocall$4", symbols: ["Quantity"] },
		{ name: "ModalExpr$macrocall$3$macrocall$2", symbols: ["ModalExpr$macrocall$4"] },
		{ name: "ModalExpr$macrocall$3$macrocall$3", symbols: [lexer.has("langle") ? { type: "langle" } : langle] },
		{ name: "ModalExpr$macrocall$3$macrocall$4", symbols: [lexer.has("rangle") ? { type: "rangle" } : rangle] },
		{ name: "ModalExpr$macrocall$3$macrocall$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "ModalExpr$macrocall$3$macrocall$1$ebnf$1", symbols: [], postprocess: () => null },
		{
			name: "ModalExpr$macrocall$3$macrocall$1",
			symbols: [
				"ModalExpr$macrocall$3$macrocall$3",
				"ModalExpr$macrocall$3$macrocall$2",
				"ModalExpr$macrocall$3$macrocall$1$ebnf$1",
				"ModalExpr$macrocall$3$macrocall$4",
			],
			postprocess: P.unwrap,
		},
		{ name: "ModalExpr$macrocall$3", symbols: ["ModalExpr$macrocall$3$macrocall$1"], postprocess: P.enclosed },
		{ name: "ModalExpr$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "ModalExpr$ebnf$2", symbols: [], postprocess: () => null },
		{ name: "ModalExpr$ebnf$3", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{
			name: "ModalExpr$macrocall$5$macrocall$1",
			symbols: [
				"ModalExpr$macrocall$5$macrocall$3",
				"ModalExpr$macrocall$5$macrocall$2",
				"ModalExpr$macrocall$5$macrocall$1$ebnf$1",
				"ModalExpr$macrocall$5$macrocall$4",
			],
			postprocess: P.unwrap,
		},
		{ name: "ModalExpr$macrocall$5", symbols: ["ModalExpr$macrocall$5$macrocall$1"], postprocess: P.enclosed },
		{
			name: "ModalExpr",
			symbols: ["ModalExpr$macrocall$3", "ModalExpr$ebnf$2", "TypeExpr", "ModalExpr$ebnf$3", "ModalExpr$macrocall$5"],
			postprocess: P.Modal,
		},
		{ name: "ModalExpr$ebnf$4", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{
			name: "ModalExpr$macrocall$7$macrocall$1",
			symbols: [
				"ModalExpr$macrocall$7$macrocall$3",
				"ModalExpr$macrocall$7$macrocall$2",
				"ModalExpr$macrocall$7$macrocall$1$ebnf$1",
				"ModalExpr$macrocall$7$macrocall$4",
			],
			postprocess: P.unwrap,
		},
		...
		{
			name: "Dict$macrocall$2$macrocall$1$macrocall$1",
			symbols: [
				"Dict$macrocall$2$macrocall$1$macrocall$3",
				"Dict$macrocall$2$macrocall$1$macrocall$2",
				"Dict$macrocall$2$macrocall$1$macrocall$1$ebnf$1",
				"Dict$macrocall$2$macrocall$1$macrocall$4",
			],
			postprocess: P.unwrap,
		},
		...
		{
			name: "Dict$macrocall$2",
			symbols: [
				"Dict$macrocall$2$ebnf$1",
				"Dict$macrocall$2$macrocall$1",
				"Dict$macrocall$2$ebnf$2",
				lexer.has("colon") ? { type: "colon" } : colon,
				"Dict$macrocall$2$ebnf$3",
				"TypeExpr",
			],
		},
		...
		{
			name: "Dict$macrocall$1$macrocall$1",
			symbols: ["Dict$macrocall$1$macrocall$3", "Dict$macrocall$1$macrocall$2", "Dict$macrocall$1$macrocall$1$ebnf$1", "Dict$macrocall$1$macrocall$4"],
			postprocess: P.unwrap,
		},
