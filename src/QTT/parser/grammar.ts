...
const grammar: Grammar = {
	...
	ParserRules: [
		...
		{ name: "App", symbols: ["App", lexer.has("ws") ? { type: "ws" } : ws, "Atom"], postprocess: P.Application },
		...
		{ name: "App", symbols: ["App", "App$ebnf$1", lexer.has("op") ? { type: "op" } : op, "App$ebnf$2", "Atom"], postprocess: P.Operation },
