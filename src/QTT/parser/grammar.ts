...
const grammar: Grammar = {
	...
	ParserRules: [
		...
		{ name: "Row$macrocall$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "Row$macrocall$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Row$macrocall$1", symbols: ["Row$macrocall$2", "Row$macrocall$1$ebnf$1", "Row$macrocall$3"], postprocess: P.none },
		...
		{ name: "Row$macrocall$5$macrocall$1$ebnf$1$subexpression$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "Row$macrocall$5$macrocall$1$ebnf$1$subexpression$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Row$macrocall$5$macrocall$1$ebnf$1$subexpression$1$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{ name: "Row$macrocall$5$macrocall$1$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "Row$macrocall$5$macrocall$1$ebnf$2", symbols: [], postprocess: () => null },
		{
			name: "Row$macrocall$5$macrocall$1",
			symbols: ["Row$macrocall$5$macrocall$1$ebnf$1", "Row$macrocall$5$macrocall$1$ebnf$2", "Row$macrocall$5$macrocall$2"],
			postprocess: P.many,
		},
		...
		{ name: "Row$macrocall$4$macrocall$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{ name: "List$macrocall$2$macrocall$1$ebnf$1$subexpression$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "List$macrocall$2$macrocall$1$ebnf$1$subexpression$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "List$macrocall$2$macrocall$1$ebnf$1$subexpression$1$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{ name: "List$macrocall$2$macrocall$1$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "List$macrocall$2$macrocall$1$ebnf$2", symbols: [], postprocess: () => null },
		{
			name: "List$macrocall$2$macrocall$1",
			symbols: ["List$macrocall$2$macrocall$1$ebnf$1", "List$macrocall$2$macrocall$1$ebnf$2", "List$macrocall$2$macrocall$2"],
			postprocess: P.many,
		},
		...
		{ name: "List$macrocall$1$macrocall$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{ name: "PatAtom$macrocall$2$macrocall$1$ebnf$1$subexpression$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "PatAtom$macrocall$2$macrocall$1$ebnf$1$subexpression$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "PatAtom$macrocall$2$macrocall$1$ebnf$1$subexpression$1$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{ name: "PatAtom$macrocall$2$macrocall$1$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "PatAtom$macrocall$2$macrocall$1$ebnf$2", symbols: [], postprocess: () => null },
		{
			name: "PatAtom$macrocall$2$macrocall$1",
			symbols: ["PatAtom$macrocall$2$macrocall$1$ebnf$1", "PatAtom$macrocall$2$macrocall$1$ebnf$2", "PatAtom$macrocall$2$macrocall$2"],
			postprocess: P.many,
		},
		...
		{ name: "PatAtom$macrocall$1$macrocall$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{ name: "PatAtom$macrocall$4$macrocall$1$ebnf$1$subexpression$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "PatAtom$macrocall$4$macrocall$1$ebnf$1$subexpression$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "PatAtom$macrocall$4$macrocall$1$ebnf$1$subexpression$1$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{ name: "PatAtom$macrocall$4$macrocall$1$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "PatAtom$macrocall$4$macrocall$1$ebnf$2", symbols: [], postprocess: () => null },
		{
			name: "PatAtom$macrocall$4$macrocall$1",
			symbols: ["PatAtom$macrocall$4$macrocall$1$ebnf$1", "PatAtom$macrocall$4$macrocall$1$ebnf$2", "PatAtom$macrocall$4$macrocall$2"],
			postprocess: P.many,
		},
		...
		{ name: "PatAtom$macrocall$3$macrocall$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{ name: "PatAtom$macrocall$6$macrocall$1$ebnf$1$subexpression$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "PatAtom$macrocall$6$macrocall$1$ebnf$1$subexpression$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "PatAtom$macrocall$6$macrocall$1$ebnf$1$subexpression$1$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{ name: "PatAtom$macrocall$6$macrocall$1$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "PatAtom$macrocall$6$macrocall$1$ebnf$2", symbols: [], postprocess: () => null },
		{
			name: "PatAtom$macrocall$6$macrocall$1",
			symbols: ["PatAtom$macrocall$6$macrocall$1$ebnf$1", "PatAtom$macrocall$6$macrocall$1$ebnf$2", "PatAtom$macrocall$6$macrocall$2"],
			postprocess: P.many,
		},
		...
		{ name: "PatAtom$macrocall$5$macrocall$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{ name: "PatAtom$macrocall$8$macrocall$1$ebnf$1$subexpression$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "PatAtom$macrocall$8$macrocall$1$ebnf$1$subexpression$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "PatAtom$macrocall$8$macrocall$1$ebnf$1$subexpression$1$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{ name: "PatAtom$macrocall$8$macrocall$1$ebnf$2", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		{ name: "PatAtom$macrocall$8$macrocall$1$ebnf$2", symbols: [], postprocess: () => null },
		{
			name: "PatAtom$macrocall$8$macrocall$1",
			symbols: ["PatAtom$macrocall$8$macrocall$1$ebnf$1", "PatAtom$macrocall$8$macrocall$1$ebnf$2", "PatAtom$macrocall$8$macrocall$2"],
			postprocess: P.many,
		},
		...
		{ name: "PatAtom$macrocall$7$macrocall$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
		...
		{ name: "PatAtom$macrocall$9$macrocall$1$ebnf$1", symbols: [lexer.has("space") ? { type: "space" } : space], postprocess: id },
