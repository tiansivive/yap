...
const grammar: Grammar = {
	...
	ParserRules: [
		...
		{ name: "Expr", symbols: ["Projection"], postprocess: id },
		{ name: "Expr", symbols: ["Injection"], postprocess: id },
		...
		{
			name: "KeyVal",
			symbols: ["Identifier", "KeyVal$ebnf$1", lexer.has("colon") ? { type: "colon" } : colon, "KeyVal$ebnf$2", "Ann"],
		...
		{
			name: "Assignment",
			symbols: ["Identifier", "Assignment$ebnf$1", lexer.has("equals") ? { type: "equals" } : equals, "Assignment$ebnf$2", "Ann"],
			postprocess: Con.keyval,
		},
		{ name: "Projection", symbols: ["Ann", lexer.has("dot") ? { type: "dot" } : dot, "Identifier"], postprocess: Con.Projection },
