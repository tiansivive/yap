...
const grammar: Grammar = {
	...
	ParserRules: [
		...
		{ name: "Pattern$macrocall$2", symbols: ["Pattern"] },
		{ name: "Pattern$macrocall$1$macrocall$2", symbols: ["Pattern$macrocall$2"] },
		{ name: "Pattern$macrocall$1$macrocall$3", symbols: [lexer.has("lparens") ? { type: "lparens" } : lparens] },
		{ name: "Pattern$macrocall$1$macrocall$4", symbols: [lexer.has("rparens") ? { type: "rparens" } : rparens] },
		...
		{ name: "Pattern", symbols: ["Pattern$macrocall$1"], postprocess: Con.extract },
