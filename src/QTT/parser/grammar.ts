...
const grammar: Grammar = {
	...
	ParserRules: [
		...
		{ name: "Atom", symbols: ["Row"], postprocess: id },
		...
		{ name: "Projection", symbols: ["Expr", lexer.has("dot") ? { type: "dot" } : dot, "Identifier"], postprocess: Con.Projection },
		...
		{ name: "Injection$macrocall$2$macrocall$2", symbols: ["KeyVal"] },
		...
		{ name: "Injection$macrocall$4$macrocall$2", symbols: ["KeyVal"] },
