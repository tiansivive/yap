...
const grammar: Grammar = {
	...
	ParserRules: [
		...
		{ name: "PatAtom$ebnf$2", symbols: ["RowTail"], postprocess: id },
		{ name: "PatAtom$ebnf$2", symbols: [], postprocess: () => null },
		{ name: "PatAtom", symbols: ["PatAtom$macrocall$5", "PatAtom$ebnf$2"], postprocess: P.Pattern.List },
