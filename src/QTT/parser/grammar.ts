...
const grammar: Grammar = {
	...
	ParserRules: [
		...
		{ name: "Expr", symbols: [lexer.has("hole") ? { type: "hole" } : hole], postprocess: Con.Hole },
		{ name: "App", symbols: ["App", lexer.has("ws") ? { type: "ws" } : ws, "Atom"], postprocess: Con.Application },
		...
		{ name: "App", symbols: ["App", "App$ebnf$1", lexer.has("op") ? { type: "op" } : op, "App$ebnf$2", "Atom"], postprocess: Con.Operation },
		...
		{ name: "Atom$macrocall$1$ebnf$1", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Atom$macrocall$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Atom$macrocall$1$ebnf$2", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		...
		{ name: "Atom", symbols: ["Block"], postprocess: id },
		...
		{ name: "Ann", symbols: ["Expr", "Ann$ebnf$1", lexer.has("colon") ? { type: "colon" } : colon, "Ann$ebnf$2", "Atom"], postprocess: Con.Annotation },
		...
		{ name: "Ann$macrocall$1$ebnf$1", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Ann$macrocall$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Ann$macrocall$1$ebnf$2", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		...
		{
			name: "Ann",
			symbols: ["Expr", "Ann$ebnf$3", lexer.has("colon") ? { type: "colon" } : colon, "Ann$ebnf$4", "Ann$macrocall$1", "Ann$ebnf$5", "Atom"],
		...
		{ name: "Param$macrocall$1$ebnf$1", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Param$macrocall$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Param$macrocall$1$ebnf$2", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		...
		{ name: "Param$macrocall$3$ebnf$1", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Param$macrocall$3$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Param$macrocall$3$ebnf$2", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		...
		{ name: "Row$ebnf$1", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "Row$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Row$ebnf$2", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Row$ebnf$2", symbols: [], postprocess: () => null },
		{ name: "Row$ebnf$3", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "Row$ebnf$3", symbols: [], postprocess: () => null },
		{
			name: "Row",
			symbols: [lexer.has("lbrace") ? { type: "lbrace" } : lbrace, "Row$ebnf$1", "Row$ebnf$2", "Row$ebnf$3", lexer.has("rbrace") ? { type: "rbrace" } : rbrace],
			postprocess: Con.emptyRow,
		},
		{ name: "Row$macrocall$2$ebnf$1", symbols: [] },
		{ name: "Row$macrocall$2$ebnf$1", symbols: ["Row$macrocall$2$ebnf$1", "RowItem"], postprocess: d => d[0].concat([d[1]]) },
		{ name: "Row$macrocall$2", symbols: ["Row$macrocall$2$ebnf$1", "EndItem"] },
		{ name: "Row$macrocall$1$ebnf$1", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Row$macrocall$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Row$macrocall$1$ebnf$2", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "Row$macrocall$1$ebnf$2", symbols: [], postprocess: () => null },
		{
			...
			symbols: [
				...
				"Row$macrocall$2",
				"Row$macrocall$1$ebnf$1",
				"Row$macrocall$1$ebnf$2",
				lexer.has("rbrace") ? { type: "rbrace" } : rbrace,
			],
			postprocess: Con.unwrapCurlyBraces,
		},
		{ name: "Row", symbols: ["Row$macrocall$1"], postprocess: Con.row },
		{ name: "EndItem$ebnf$1", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "EndItem$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "EndItem$ebnf$2", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "EndItem$ebnf$2", symbols: [], postprocess: () => null },
		{ name: "EndItem", symbols: ["EndItem$ebnf$1", "EndItem$ebnf$2", "KeyVal"], postprocess: d => d[2] },
		{ name: "RowItem$ebnf$1", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "RowItem$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "RowItem$ebnf$2", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "RowItem$ebnf$2", symbols: [], postprocess: () => null },
		{ name: "RowItem", symbols: ["RowItem$ebnf$1", "RowItem$ebnf$2", "KeyVal", lexer.has("comma") ? { type: "comma" } : comma], postprocess: d => d[2] },
		...
		{ name: "Block$macrocall$2$ebnf$1", symbols: ["Statement"] },
		{ name: "Block$macrocall$2$ebnf$1", symbols: ["Block$macrocall$2$ebnf$1", "Statement"], postprocess: d => d[0].concat([d[1]]) },
		{ name: "Block$macrocall$2$ebnf$2$macrocall$2", symbols: ["Return"] },
		{ name: "Block$macrocall$2$ebnf$2$macrocall$1$ebnf$1", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "Block$macrocall$2$ebnf$2$macrocall$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Block$macrocall$2$ebnf$2$macrocall$1$ebnf$2", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Block$macrocall$2$ebnf$2$macrocall$1$ebnf$2", symbols: [], postprocess: () => null },
		{ name: "Block$macrocall$2$ebnf$2$macrocall$1$ebnf$3", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "Block$macrocall$2$ebnf$2$macrocall$1$ebnf$3", symbols: [], postprocess: () => null },
		{ name: "Block$macrocall$2$ebnf$2$macrocall$1$ebnf$4", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Block$macrocall$2$ebnf$2$macrocall$1$ebnf$4", symbols: [], postprocess: () => null },
		{
		...
		{ name: "Block$macrocall$2$ebnf$2", symbols: ["Block$macrocall$2$ebnf$2$macrocall$1"], postprocess: id },
		{ name: "Block$macrocall$2$ebnf$2", symbols: [], postprocess: () => null },
		{ name: "Block$macrocall$2", symbols: ["Block$macrocall$2$ebnf$1", "Block$macrocall$2$ebnf$2"] },
		{ name: "Block$macrocall$1$ebnf$1", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Block$macrocall$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Block$macrocall$1$ebnf$2", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		...
		{ name: "Block$macrocall$4$macrocall$2", symbols: ["Return"] },
		{ name: "Block$macrocall$4$macrocall$1$ebnf$1", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "Block$macrocall$4$macrocall$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Block$macrocall$4$macrocall$1$ebnf$2", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Block$macrocall$4$macrocall$1$ebnf$2", symbols: [], postprocess: () => null },
		{ name: "Block$macrocall$4$macrocall$1$ebnf$3", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "Block$macrocall$4$macrocall$1$ebnf$3", symbols: [], postprocess: () => null },
		{ name: "Block$macrocall$4$macrocall$1$ebnf$4", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Block$macrocall$4$macrocall$1$ebnf$4", symbols: [], postprocess: () => null },
		{
			name: "Block$macrocall$4$macrocall$1",
			symbols: [
				"Block$macrocall$4$macrocall$1$ebnf$1",
				"Block$macrocall$4$macrocall$1$ebnf$2",
				"Block$macrocall$4$macrocall$2",
				"Block$macrocall$4$macrocall$1$ebnf$3",
				"Block$macrocall$4$macrocall$1$ebnf$4",
				lexer.has("semicolon") ? { type: "semicolon" } : semicolon,
			],
			postprocess: Con.unwrapStatement,
		},
		{ name: "Block$macrocall$4", symbols: ["Block$macrocall$4$macrocall$1"] },
		{ name: "Block$macrocall$3$ebnf$1", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Block$macrocall$3$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Block$macrocall$3$ebnf$2", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "Block$macrocall$3$ebnf$2", symbols: [], postprocess: () => null },
		{
			name: "Block$macrocall$3",
			symbols: [
				lexer.has("lbrace") ? { type: "lbrace" } : lbrace,
				"Block$macrocall$4",
				"Block$macrocall$3$ebnf$1",
				"Block$macrocall$3$ebnf$2",
				lexer.has("rbrace") ? { type: "rbrace" } : rbrace,
			],
			postprocess: Con.unwrapCurlyBraces,
		},
		...
		{ name: "Statement$macrocall$1$ebnf$1", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "Statement$macrocall$1$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Statement$macrocall$1$ebnf$2", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Statement$macrocall$1$ebnf$2", symbols: [], postprocess: () => null },
		{ name: "Statement$macrocall$1$ebnf$3", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "Statement$macrocall$1$ebnf$3", symbols: [], postprocess: () => null },
		{ name: "Statement$macrocall$1$ebnf$4", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Statement$macrocall$1$ebnf$4", symbols: [], postprocess: () => null },
		{
		...
		{ name: "Statement", symbols: ["Statement$macrocall$1"], postprocess: Con.Expr },
		{ name: "Statement$macrocall$4", symbols: ["Letdec"] },
		{ name: "Statement$macrocall$3$ebnf$1", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "Statement$macrocall$3$ebnf$1", symbols: [], postprocess: () => null },
		{ name: "Statement$macrocall$3$ebnf$2", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Statement$macrocall$3$ebnf$2", symbols: [], postprocess: () => null },
		{ name: "Statement$macrocall$3$ebnf$3", symbols: [lexer.has("NL") ? { type: "NL" } : NL], postprocess: id },
		{ name: "Statement$macrocall$3$ebnf$3", symbols: [], postprocess: () => null },
		{ name: "Statement$macrocall$3$ebnf$4", symbols: [lexer.has("ws") ? { type: "ws" } : ws], postprocess: id },
		{ name: "Statement$macrocall$3$ebnf$4", symbols: [], postprocess: () => null },
		{
		...
		{ name: "Return", symbols: [{ literal: "return" }, lexer.has("ws") ? { type: "ws" } : ws, "Expr"], postprocess: Con.Return },
