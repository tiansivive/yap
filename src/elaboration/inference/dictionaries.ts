...
export const infer = (dict: Dictionary): M.Elaboration<EB.AST> =>
	M.tracer.track({ tag: "src", type: "term", term: dict, metadata: { action: "infer", description: "Dictionary" } }, function* () {
