...
export const Constructors = {
	Expr: {
		Var: (name: string, debug?: Debug): Expr => ({ type: "Var", name, debug }),
		Lit: (value: Literal, debug?: Debug): Expr => ({ type: "Lit", value, debug }),
		FuncRef: (name: string, debug?: Debug): Expr => ({ type: "FuncRef", name, debug }),
		PrimOp: (op: string, args: string[], debug?: Debug): Expr => ({ type: "PrimOp", op, args, debug }),
	},
	Instr: {
		Let: (name: string, expr: Expr, debug?: Debug): Instr => ({ type: "Let", name, expr, debug }),
		Read: (label: string, target: string, result: string, debug?: Debug): Instr => ({ type: "Read", label, target, result, debug }),
		...
		Alloc: (alloc: Allocation, result: string, debug?: Debug): Instr => ({ type: "Alloc", alloc, result, debug }),
		Call: (target: CallTarget, args: string[], result: string, debug?: Debug): Instr => ({ type: "Call", target, args, result, debug }),
	},
	Terminator: {
		Jump: (target: Label, args: string[], debug?: Debug): Terminator => ({ type: "Jump", target, args, debug }),
		...
		Return: (value: string, debug?: Debug): Terminator => ({ type: "Return", value, debug }),
	},
